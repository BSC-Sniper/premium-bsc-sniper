...
3. Una vez extraido el .zip, vas a ver una carpeta que se llama _"premium-bsc-sniper"_ y dentro de ella tres archivos (**NO ELIMINES NI CAMBIES NIGUN ARCHIVO**). Estos archivos:
